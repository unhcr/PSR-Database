create table S_LOCATION_SUBDIVISIONS_2013
 (COU_CODE varchar2(3),
  COU_START_DATE date,
 ...
 (type oracle_loader
  ...
  access parameters 
   (records delimited by '\r\n'
    characterset UTF8
    badfile 'LOCATION_SUBDIVISIONS_2013.bad'
    nodiscardfile
    logfile PSRLOG:'LOCATION_SUBDIVISIONS_2013.log'
    skip 1 
  ...
  location ('LOCATION_SUBDIVISIONS_UTF8_2013.csv'))
reject limit unlimited;

grant select on S_LOCATION_SUBDIVISIONS_2013 to PSR_STAGE;