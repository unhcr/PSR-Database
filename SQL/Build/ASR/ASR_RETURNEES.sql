...
Q_DISPLACEMENT_STATUSES as
 (select ID, DESCRIPTION, CODE
  ...
  where RANK = 1)
--
select cast(RET.ASR_YEAR as number(4)) as ASR_YEAR, RET.LOC_ID_ORIGIN_COUNTRY,
  RET.DST_ID, DST.DESCRIPTION as DST_DESCRIPTION, DST.CODE as DST_CODE,
  RET.LOC_ID_ASYLUM_COUNTRY, LOC.NAME as LOC_NAME_ASYLUM_COUNTRY,
...
left outer join Q_LOCATIONS LOC
  on LOC.ID = RET.LOC_ID_ASYLUM_COUNTRY
