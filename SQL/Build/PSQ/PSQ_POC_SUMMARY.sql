...
select SUM.ASR_YEAR,
  ...
  SUM.UNSD_GSR_ITM_ID_RESIDENCE, SUM.UNSD_GSR_ORDER_SEQ_RESIDENCE,
  SUM.UNSD_MGR_ITM_ID_RESIDENCE, SUM.UNSD_MGR_ORDER_SEQ_RESIDENCE,
  SUM.UNHCR_ROP_ITM_ID_RESIDENCE, SUM.UNHCR_ROP_ORDER_SEQ_RESIDENCE,
  SUM.UNHCR_BUR_ITM_ID_RESIDENCE, SUM.UNHCR_BUR_ORDER_SEQ_RESIDENCE,
  SUM.COU_CODE_ORIGIN, SUM.ISO3166_ALPHA3_CODE_ORIGIN,
  coalesce(TXT2.TEXT, TXT3.TEXT, NAM2.NAME) as COU_NAME_ORIGIN,
  SUM.UNSD_GSR_ITM_ID_ORIGIN, SUM.UNSD_GSR_ORDER_SEQ_ORIGIN,
  SUM.UNSD_MGR_ITM_ID_ORIGIN, SUM.UNSD_MGR_ORDER_SEQ_ORIGIN,
  SUM.UNHCR_ROP_ITM_ID_ORIGIN, SUM.UNHCR_ROP_ORDER_SEQ_ORIGIN,
  SUM.UNHCR_BUR_ITM_ID_ORIGIN, SUM.UNHCR_BUR_ORDER_SEQ_ORIGIN,
...
left outer join T_TEXT_ITEMS TXT1
  on TXT1.ITM_ID = SUM.ITM_ID_RESIDENCE
