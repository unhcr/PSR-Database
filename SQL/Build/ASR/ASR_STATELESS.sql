...
select cast(STA.ASR_YEAR as number(4)) as ASR_YEAR, STA.LOC_ID_ASYLUM_COUNTRY,
  ...
  STA.STAPOP_START_VALUE, STA.STAPOP_START_STC_ID, STA.STAPOP_START_VERSION_NBR,
  STA.STAPOP_START_ITM_ID,
  STA.STAPOP_AH_START_VALUE, STA.STAPOP_AH_START_STC_ID, STA.STAPOP_AH_START_VERSION_NBR,
  STA.STAPOP_AH_START_ITM_ID, STA.NATLOSS_VALUE,
  STA.NATLOSS_STC_ID, STA.NATLOSS_VERSION_NBR, STA.NATLOSS_ITM_ID,
  STA.STAOTHINC_VALUE, STA.STAOTHINC_STC_ID, STA.STAOTHINC_VERSION_NBR, STA.STAOTHINC_ITM_ID,
  STA.NATACQ_VALUE, STA.NATACQ_STC_ID, STA.NATACQ_VERSION_NBR, STA.NATACQ_ITM_ID,
  STA.STAOTHDEC_VALUE, STA.STAOTHDEC_STC_ID, STA.STAOTHDEC_VERSION_NBR, STA.STAOTHDEC_ITM_ID,
  STA.STAPOP_END_VALUE, STA.STAPOP_END_STC_ID, STA.STAPOP_END_VERSION_NBR, STA.STAPOP_END_ITM_ID,
  STA.STAPOP_AH_END_VALUE, STA.STAPOP_AH_END_STC_ID, STA.STAPOP_AH_END_VERSION_NBR,
  STA.STAPOP_AH_END_ITM_ID,
