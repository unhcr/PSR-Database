...
--
select cast(RSD.ASR_YEAR as number(4)) as ASR_YEAR,
  COU1.ITM_ID as ITM_ID_ASYLUM,
  cast(COU1.ISO3166_NUMERIC_CODE as varchar2(3)) as COU_CODE_ASYLUM,
  cast(COU1.ISO3166_ALPHA3_CODE as varchar2(3)) as ISO3166_ALPHA3_CODE_ASYLUM,
...
select RSD.ASR_YEAR,
  RSD.COU_CODE_ASYLUM, RSD.ISO3166_ALPHA3_CODE_ASYLUM,
  nvl(TXT1.TEXT, NAM1.NAME) as COU_NAME_ASYLUM,
  RSD.COU_CODE_ORIGIN, RSD.ISO3166_ALPHA3_CODE_ORIGIN,
...
left outer join T_TEXT_ITEMS TXT1
  on TXT1.ITM_ID = RSD.ITM_ID_ASYLUM
