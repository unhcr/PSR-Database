...
select cast(OOC.ASR_YEAR as number(4)) as ASR_YEAR, OOC.LOC_ID_ASYLUM_COUNTRY,
  ...
  OOC.OOCPOP_START_VALUE, OOC.OOCPOP_START_STC_ID, OOC.OOCPOP_START_VERSION_NBR,
  OOC.OOCPOP_START_ITM_ID,
  OOC.OOCPOP_AH_START_VALUE, OOC.OOCPOP_AH_START_STC_ID, OOC.OOCPOP_AH_START_VERSION_NBR,
  OOC.OOCPOP_AH_START_ITM_ID,
  OOC.OOCARR_VALUE, OOC.OOCARR_STC_ID, OOC.OOCARR_VERSION_NBR, OOC.OOCARR_ITM_ID,
  OOC.OOCOTHINC_VALUE, OOC.OOCOTHINC_STC_ID, OOC.OOCOTHINC_VERSION_NBR, OOC.OOCOTHINC_ITM_ID,
  OOC.OOCRTN_VALUE, OOC.OOCRTN_STC_ID, OOC.OOCRTN_VERSION_NBR, OOC.OOCRTN_ITM_ID,
  OOC.OOCOTHDEC_VALUE, OOC.OOCOTHDEC_STC_ID, OOC.OOCOTHDEC_VERSION_NBR, OOC.OOCOTHDEC_ITM_ID,
  OOC.OOCPOP_END_VALUE, OOC.OOCPOP_END_STC_ID, OOC.OOCPOP_END_VERSION_NBR, OOC.OOCPOP_END_ITM_ID,
  OOC.OOCPOP_AH_END_VALUE, OOC.OOCPOP_AH_END_STC_ID, OOC.OOCPOP_AH_END_VERSION_NBR,
  OOC.OOCPOP_AH_END_ITM_ID,
