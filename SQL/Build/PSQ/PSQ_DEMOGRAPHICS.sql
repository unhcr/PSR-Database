...
from
 (select DEM.ASR_YEAR,
  ...
  from
   (select DEM.ASR_YEAR, DEM.DST_ID,
      DEM.LOC_ID_ASYLUM_COUNTRY, DEM.LOC_ID_ASYLUM,
      nvl(DEM.LOC_ID_ORIGIN_COUNTRY, LVAR.ID) as LOC_ID_ORIGIN_COUNTRY,
      DEM.REDACTION_LIMIT,
      DEM.F0_VALUE, DEM.F5_VALUE, DEM.F12_VALUE, DEM.F18_VALUE, DEM.F60_VALUE, DEM.FOTHER_VALUE,
      DEM.M0_VALUE, DEM.M5_VALUE, DEM.M12_VALUE, DEM.M18_VALUE, DEM.M60_VALUE, DEM.MOTHER_VALUE,
      DEM.TOTAL_VALUE
    ...
    cross join
     (select LOC.ID
      ...
      where LOCT_CODE = 'OTHORIGIN') LVAR) DEM
...
from
 (select DEM.ASR_YEAR,
    ...
    coalesce(TXT2.TEXT, TXT3.TEXT, NAM3.NAME) as COU_NAME_ORIGIN,
    DEM.DST_CODE,
  ...
  left outer join T_TEXT_ITEMS TXT1
    on TXT1.ITM_ID = DEM.ITM_ID_LOC_RESIDENCE_COUNTRY
  ...
  left outer join T_TEXT_ITEMS TXT2
    on TXT2.ITM_ID = DEM.ITM_ID_LOC_ORIGIN_COUNTRY
    and TXT2.TXTT_CODE = 'ORIGINNAME'
    and TXT2.SEQ_NBR = 1
    and TXT2.LANG_CODE = NAM3.LANG_CODE
  left outer join T_TEXT_ITEMS TXT3
    on TXT3.ITM_ID = DEM.ITM_ID_LOC_ORIGIN_COUNTRY
    and TXT3.TXTT_CODE = 'PSRNAME'
    and TXT3.SEQ_NBR = 1
    and TXT3.LANG_CODE = NAM3.LANG_CODE
